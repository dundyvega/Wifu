...
public class HaromControl  implements Initializable {
    ...
    void saveOnAction(ActionEvent event) {
    	...
    	FileChooser.ExtensionFilter extFilter = new FileChooser.ExtensionFilter("NYA files (*.nya)", "*.nya");
    	fileChooser.getExtensionFilters().add(extFilter);
    	fileChooser.setInitialFileName("uknown.nya");
    	...
    	if(file != null){
            try {
            	...
            	FileAdministrator.saveInFile(file);
    ...
    void saveAsOnAction(ActionEvent event) {
    	...
    	FileChooser fileChooser = new FileChooser();
    	 ...
    	 fileChooser.getExtensionFilters().add(extFilter);
    	 fileChooser.setInitialFileName("uknown.png");
    ...
    void openAction(ActionEvent event) {
    	...
    	fileChooser.getExtensionFilters().addAll(
                new FileChooser.ExtensionFilter("nya", "*.nya"),
                new FileChooser.ExtensionFilter("NYA", "*.NYA")
    	...
    	if (file != null) {
    		FileAdministrator.setFile(file);
    	}
    	painting2();
    ...
    @FXML
    void fitMenuOnAction(ActionEvent e) {
    	FileAdministrator.fit();
    	painting2();
    }
   ...
   public void painting(String category, String item) {
    	...
    	/*	ColorAdjust adj= new ColorAdjust();
    		...
    		*/
            ...
            // System.out.println(im.getWidth() + " /" + im.getHeight());
             ...
             imageViewDest.setRotationAxis(Rotate.Y_AXIS);
             f = im.getMyF();
             //System.out.println(f);
             imageViewDest.setRotate(f);
	...
	public void resizeButtonOnAction(ActionEvent e) {
		...
		//if (!isAnAccessory(tagName)) {
			...
			Alert alert = new Alert(Alert.AlertType.INFORMATION);
		      ...
		      boolean accessory = isAnAccessory(tagName);
		       
		       int hw[] = FileAdministrator.getWidthHightOfTag(tagName, accessory);
		       
		       TextField height = new TextField(hw[1] + ""); grid.setRowIndex(height, 4); grid.setColumnIndex(height, 0); height.setId("height");
		       TextField width = new TextField(hw[0] + ""); grid.setRowIndex(width, 4); grid.setColumnIndex(height, 1); width.setId("width");
		       ...
		       EventHandler<ActionEvent> moveHandler = new EventHandler<ActionEvent>() {
		    	    ...
		    	    public void handle(ActionEvent event) {
		    	      ...
		    	      // System.out.println(move);
		    	    	   ...
		    	    	   moved(move, tagName, isAnAccessory(tagName));
		    	  ...
		    	  EventHandler<ActionEvent> resizeHandler = new EventHandler<ActionEvent>() {
			    	    ...
			    	    public void handle(ActionEvent event) {
			    	    	try {
			    	    		...
			    	    		FileAdministrator.resize(tagName, url, w, h, accessory);
	...
	public void moved(String move, String tagName, boolean accessory) {
		
		String url = FileAdministrator.getURL(tagName);
		//System.out.println(url);
		
		if (move.equals("up")) {
			FileAdministrator.move(tagName, url, -10, 0, accessory);
		} else 		
			if (move.equals("down")) {
			FileAdministrator.move(tagName, url, 10, 0, accessory);
		} else
			if (move.equals("right")) {
				FileAdministrator.move(tagName, url, 0, 10, accessory);
			} 		if (move.equals("left")) {
				FileAdministrator.move(tagName, url, 0, -10, accessory);
			}
		...
		String tagName = getTagByAction(e);
			...
			Alert alert = new Alert(Alert.AlertType.INFORMATION);
		      ...
		      alert.setGraphic(new ImageView(WifuControlClass.class.getResource("/images/quast_1.png").toString()));
		       ...
		       int hw[] = FileAdministrator.getRGB(tagName, accessory);
		       
		       Slider red = new Slider(0, 255, hw[0]); grid.setRowIndex(red, 1); grid.setColumnIndex(red, 1); red.setId("red");
		       Slider blue = new Slider(0, 255, hw[2]); grid.setRowIndex(blue, 5); grid.setColumnIndex(blue, 1); blue.setId("blue");
		       Slider green = new Slider(0, 255, hw[1]); grid.setRowIndex(green, 3); grid.setColumnIndex(green, 1); green.setId("green");
				    ...
				    public void changed(ObservableValue<? extends Number> observable,
				     ...
				     //  g.setFill(color);
				      // g.fillRect(0, 0, 100, 100);
				       ...
				       FileAdministrator.setColor(tagName, url, rInt, gInt, bInt, accessory);
